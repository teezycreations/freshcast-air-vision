...
const WeatherCard: React.FC = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-tertiary to-card-bg rounded-3xl p-5 h-[41vh] animate-fade-in">
        ...
        <div className="flex flex-col h-full justify-between">
          ...
          <div className="mt-3">
            <div className="flex items-end">
              ...
              <span className="text-xl mb-1">{isCelsius ? 'C' : 'F'}</span>
            </div>
      ...
      <div className="mt-4 grid grid-cols-3 gap-4">
        ...
        <div className="bg-tertiary/30 p-3 rounded-lg">
          <p className="text-xs text-text-secondary">Day Length</p>
          <p className="text-lg font-semibold">{dayLength.hours}h {dayLength.minutes}min</p>
        </div>
      </div>
    </div>
  );
